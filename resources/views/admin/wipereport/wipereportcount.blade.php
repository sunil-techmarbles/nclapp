	 ...
	 <div class="row">
        <div class="col-sm-12" style="text-align: right">
            <form method="post" class="form-inline" id="statsform" action="{{route('getwipereportfilescount')}}">
            	@csrf
                <input type="text" style="display: inline-block;width:200px;margin-right: 15px;" class="form-control daterange" id="dates" name="dates" value="" />
